...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="resources/images/umbrella180x180.png">
	<link rel="icon" type="image/png" sizes="32x32" href="resources/images/umbrella32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="resources/images/umbrella16x16.png">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-5">
					<img src="resources/images/umbrellaimg.png" alt="">
				</div>
