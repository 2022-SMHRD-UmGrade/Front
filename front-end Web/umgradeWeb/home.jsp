...
<body>
		...
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="card-group mb-30">
				<div class="card card-box">
					<img class="card-img-top" src="vendors/images/people.png" alt="Card image cap">
					<div class="card-body">
				...
				<div class="card card-box">
					<img class="card-img-top" src="vendors/images/umbrellaimg.png" alt="Card image cap">
					<div class="card-body">
				...
				<div class="card card-box">
					<img class="card-img-top" src="vendors/images/umbrellabox.png" alt="Card image cap">
					<div class="card-body">
	...
	<script src="src/plugins/jvectormap/jquery-jvectormap-kr-mill.js"></script>
