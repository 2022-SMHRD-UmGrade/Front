...
<body>
		...
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="card-group mb-30">
				<div class="card card-box">
					<img class="card-img-top" src="resources/images/people.png" alt="Card image cap">
					<div class="card-body">
				...
				<div class="card card-box">
					<img class="card-img-top" src="resources/images/umbrellaimg.png" alt="Card image cap">
					<div class="card-body">
				...
				<div class="card card-box">
					<img class="card-img-top" src="resources/images/umbrellabox.png" alt="Card image cap">
					<div class="card-body">
	...
	<script src="resources/src/plugins/jQuery-Knob-master/jquery.knob.min.js"></script>
	<script src="resources/src/plugins/apexcharts/apexcharts.min.js"></script>
	<script src="resources/src/plugins/highcharts-6.0.7/code/highcharts.js"></script>
	<script src="resources/src/plugins/highcharts-6.0.7/code/highcharts-more.js"></script>
	<script src="resources/src/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
	<script src="resources/src/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script src="resources/src/plugins/jvectormap/jquery-jvectormap-kr-mill.js"></script>
