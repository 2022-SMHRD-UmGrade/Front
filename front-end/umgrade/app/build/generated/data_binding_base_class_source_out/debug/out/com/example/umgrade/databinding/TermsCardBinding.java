...
public final class TermsCardBinding implements ViewBinding {
  @NonNull
  ...
  private TermsCardBinding(@NonNull CardView rootView, @NonNull TextView textView14,
  ...
  @NonNull
  public static TermsCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TermsCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.terms_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TermsCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TermsCardBinding((CardView) rootView, textView14, textView15, textView16,
