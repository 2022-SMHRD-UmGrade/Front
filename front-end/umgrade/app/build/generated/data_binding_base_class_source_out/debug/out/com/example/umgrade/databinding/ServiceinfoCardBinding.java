...
public final class ServiceinfoCardBinding implements ViewBinding {
  @NonNull
  ...
  private ServiceinfoCardBinding(@NonNull CardView rootView, @NonNull TextView textView14,
  ...
  @NonNull
  public static ServiceinfoCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ServiceinfoCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.serviceinfo_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ServiceinfoCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ServiceinfoCardBinding((CardView) rootView, textView14, textView15, textView16,
