...
public final class PrivacyCardBinding implements ViewBinding {
  @NonNull
  ...
  private PrivacyCardBinding(@NonNull CardView rootView, @NonNull TextView textView14,
  ...
  @NonNull
  public static PrivacyCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PrivacyCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.privacy_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PrivacyCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PrivacyCardBinding((CardView) rootView, textView14, textView15, textView16,
